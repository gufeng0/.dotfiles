...
# Root of this dotfiles repo; self-locating so it follows the ~/.zshrc
# symlink created by scripts/setup.sh.
...
zinit snippet "$DOTFILES_DIR/zsh/zoxide.sh"

# zinit ice lucid wait='1'
zinit snippet "$DOTFILES_DIR/zsh/platform.sh"

zinit ice lucid wait='1'
zinit snippet "$DOTFILES_DIR/zsh/functions.sh"

zinit ice lucid wait='1'
zinit snippet "$DOTFILES_DIR/zsh/proxy.sh"

zinit ice lucid wait='1'
zinit snippet "$DOTFILES_DIR/zsh/git.sh"

zinit snippet "$DOTFILES_DIR/zsh/vi-mode.zsh"
zinit snippet "$DOTFILES_DIR/zsh/vi-im-switch.zsh"
...
# zinit snippet $DOTFILES_DIR/zsh/lu5je0.zsh-theme # lu5je0
...
alias vz='vi $DOTFILES_DIR/zshrc'
alias sz='exec zsh'
