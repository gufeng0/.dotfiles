...
function M.setup()
  ...
  local n_mappings = {
    ...
    g = {
      ...
      f = { '<cmd>DiffBanditGit<cr>', 'diffbandit changed files' },
      F = { '<cmd>DiffBanditGitCurrent<cr>', 'diffbandit current file diff' },
      p = { '<cmd>DiffBanditCommitPanel<cr>', 'diffbandit commit panel' },
